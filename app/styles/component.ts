...
export const style = {
  header: {
    div: tv({ base: "p-2 rounded-lg select-none mb-1" }),
    link: tv({
      base: [
        "p-2 my-2 rounded-lg",
    ...
    clerk: {
      ...
      icon: tv({ base: "h-6 rounded-full my-2 mx-1" }),
    },
  },
  ...
  text: {
    title: tv({ base: "text-3xl mb-4 font-bold text-slate-800 dark:text-slate-200" }),
    sectionTitle: tv({
