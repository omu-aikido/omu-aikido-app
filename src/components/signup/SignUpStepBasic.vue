      ...
      <Input
        ...
        <template #suffix>
          <button
            type="button"
            :disabled="isSignUpCreated"
            class="bg-transparent border-none text-fg-dim cursor-pointer transition-colors p-0 flex items-center justify-center hover:text-fg disabled:opacity-50 disabled:cursor-not-allowed"
